...
public class CreateUser extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        findViewById(R.id.userpropv).setOnClickListener(v->{
            ...
            ed[keyn].setId(keyn);
            ed[keyn].setHint("Enter User Property Value");
        ...
        findViewById(R.id.cubt).setOnClickListener(v->{
            ...
            Log.d("flagcheck","cc"+c1.isChecked()+c2.isChecked()+c3.isChecked()+c4.isChecked());
